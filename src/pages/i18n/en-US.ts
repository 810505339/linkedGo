...
export default {
  ...
  facestatus: {
    ...
    tag2: 'Possible cause: Third party detection error',
    tag3: 'Next',
    tag4: 'Take a new photo',
  },
  userInfo: {
