...
const LaunchWine = () => {
  ...
  const list: IItem[] = [
    ...
    { label: t('launchwine.tag1'), render: () => (<TextInput mode='outlined' outlineStyle={{ borderRadius: 10 }} style={{ height: 40, borderRadius: 10, fontSize: 14 }} contentStyle={{ height: 42 }} className="bg-[#221F1F80]" value={data.partyName} onChangeText={(text) => setData(draft => { draft.partyName = text; })} placeholder='请输入酒局名称' />) },
    /* 选择日期 */
    {
